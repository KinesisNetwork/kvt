  ...
  <div className='section_title text-center mb-60'>
    ...
    <div className='mt-30'>
      ...
      <div className='text-left'>
        ...
        <p>At the nominated date and time, buy your Kinesis Tokens (KVT) by following the user-friendly instructions on our website.</p>
      </div>
    </div>
    <div className='mt-30'>
    ...
    <div className='mt-30'>
      ...
      <ol style={{listStyleType: 'upper-roman', paddingLeft: '20px', maxWidth: '800px', margin: '0 auto', textAlign: 'left'}}>
