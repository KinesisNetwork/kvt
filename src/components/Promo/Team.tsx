          ...
          <div className='container'>
            ...
            <div className='row'>
              ...
              <div className='col-sm-4 col-xs-12'>
                <div className='content'>
                  <div className='img_container'>
                    <img src='images/team/2.png' alt='team' className='img-responsive' style={{maxWidth: '200px'}}/>
                    <h3 className='team_info wow fadeInUp'>
                      Michael Coughlin
                    </h3>
            ...
            <div className='row'>
              <div className='col-sm-4 col-xs-12'>
                <div className='content'>
                  <div className='img_container'>
                    <img src='images/team/4.png' alt='team' className='img-responsive' style={{maxWidth: '200px'}}/>
                    <h3 className='team_info wow fadeInUp'>
                      David Underwood
                    </h3>
                    <span className='team_title'>Non-Executive Director</span>
              ...
              <div className='col-sm-4 col-xs-12'>
                <div className='content'>
                  <div className='img_container'>
                    <img src='images/team/5.jpg' alt='team' className='img-responsive' style={{maxWidth: '200px'}}/>
                    <h3 className='team_info wow fadeInUp'>
                     Rosalyn Charlton
                    </h3>
              ...
              <div className='col-sm-4 col-xs-12'>
                <div className='content'>
                  <div className='img_container'>
                    <img src='images/team/6.jpg' alt='team' className='img-responsive' style={{maxWidth: '200px'}}/>
                    <h3 className='team_info wow fadeInUp'>
                     Eric Maine
                    </h3>
