        ...
        <section className='services pt-80 pb-80' style={{color: 'white'}} id='about'>
          <div className='container'>
            <div className='section_title text-center mb-60' style={{textAlign: 'left', marginBottom: '-60px'}}>
              ...
              <p>The Kinesis system is an evolutionary step beyond any current monetary system available in the world today. It enhances money as both a store of value and a medium of exchange, and has been developed for the benefit of all.</p>
