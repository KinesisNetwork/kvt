            ...
            <div className='row text-center m-0'>
              <div className='col-xs-6 col-sm-4 border-right'>
                <div className='content'>
                  ...
                  <h3>Security</h3>
                  <p>Employing the highest standards of digital security across blockchain networks and data storage technologies, along with well-established fully insured ABX vaulting operations and secure exchange platforms, Kinesis system provides users with an institutional grade solution with minimised risk.</p>
                </div>
                {/* End of .content */}
              </div>
              {/* End fo .col-sm-4 */}
