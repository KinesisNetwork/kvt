        ...
        <section className='services pt-80 pb-80' style={{color: 'white'}} id='referrer'>
          <div className='container'>
            <div className='section_title text-center'>
              ...
              <p>Simply complete the online enrolment form to receive your unique referrer URL. Be at the forefront of introducing Kinesis to your network and the world at large!</p>
            </div>
          </div>
        </section>
      </div>
