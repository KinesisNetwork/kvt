      ...
      <nav className='navbar navbar-default pt-10'>
        <div className='container-fluid pl-30 pr-30'>
          <div className='navbar-header'>
            ...
            <ScrollLink to='home' spy={true} smooth={true} offset={0} duration={500} className='navbar-brand' style={{ cursor: 'pointer' }}>
          ...
          {(!this.props.hideNavigation) && (
            <div className='collapse navbar-collapse' id='my_nav'>
              <ul className='nav navbar-nav navbar-right'>
                <li style={{ cursor: 'pointer' }}><ScrollLink to='about' spy={true} smooth={true} offset={0} duration={500}>currency</ScrollLink></li>
                ...
                <li style={{ cursor: 'pointer' }}><ScrollLink to='whitepaper' spy={true} smooth={true} offset={-60} duration={500}>whitepaper</ScrollLink></li>
